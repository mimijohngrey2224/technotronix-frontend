...
function Register() {
  ...
  const registerHandler = async (e) => {
    ...
    try {
      ...
      } else if (data === "no match") {showAndHide("error", "Password do not match");
  ...
  return (
          ...
          <div className='w-[60%] mx-auto font-semibold my-[5%]'>
                            ...
                            <form onSubmit={registerHandler}>
                                ...
                                <div className='flex flex-col gap-3 mb-3'>
                                  <label className='font-bold' htmlFor="lastName">Last Name</label>
                                     <input className="outline outline-1 p-[10]" type="text" onChange={(e) => setLastName(e.target.value)} />
                                 </div>
                                <div className='flex flex-col gap-3 mb-3'>
                                 ...
                                 <div>
                                   <button className='bg-black text-white p-[10px] rounded-md hover:bg-orange-500'>Register</button>
                                 </div>
